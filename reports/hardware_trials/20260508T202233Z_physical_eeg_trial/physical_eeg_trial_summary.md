# Physical EEG Trial: 20260508T202233Z_physical_eeg_trial

- Status: `completed`
- Profile: `brainflow_synthetic_eeg`
- Synthetic mode: `True`
- Physical device detected: `False`
- Closed-loop allowed: `False`
- Observed rate: `247.8916` Hz
- Jitter p95: `0.026` ms
- Alpha status: `noisy_signal`
- Alpha ratio closed/open: `0.947471`
- Shadow windows: `2`
