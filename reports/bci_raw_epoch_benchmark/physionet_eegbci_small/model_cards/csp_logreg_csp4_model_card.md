# Model Card: physionet_eegbci_small_csp_logreg_csp4
...
```json
{
  ...
  "balanced_accuracy": 0.5778642936596218,
  "macro_f1": 0.5688416211555045,
  "weighted_f1": 0.5714764779151096,
  "per_class": {
    "LEFT_HAND_IMAGERY": {
      "precision": 0.575,
    ...
    "accuracy": 0.5833333333333334,
    "macro avg": {
      "precision": 0.5874999999999999,
      "recall": 0.5778642936596218,
      "f1-score": 0.5688416211555045,
      "support": 60.0
    },
    "weighted avg": {
      "precision": 0.5870833333333333,
      "recall": 0.5833333333333334,
      "f1-score": 0.5714764779151096,
      "support": 60.0
    }
  },
  "confusion_matrix": [
  ...
  "calibration": {
    "available": true,
    "ece": 0.0842693609746869,
    "mce": 0.8130528314442229,
    "reliability_bins": [
      {
        "lo": 0.0,
        "hi": 0.1,
    ...
    "brier_score": 0.26514975324498075
  },
  "auroc": 0.5383759733036708,
  "split_strategy": "group_run",
  "split_warnings": [],
  "latency": {
    "mean_inference_latency_ms": 0.49484371666039806,
    "p95_inference_latency_ms": 1.025916599428449,
    "p99_inference_latency_ms": 3.4182044004046466,
    "throughput_samples_per_sec": 2020.8400477403277
  },
  "per_subject": {
    "S001": {
      "task_type": "classification",
