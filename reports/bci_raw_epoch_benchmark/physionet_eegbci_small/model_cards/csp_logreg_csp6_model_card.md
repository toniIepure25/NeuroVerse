# Model Card: physionet_eegbci_small_csp_logreg_csp6
...
```json
{
  ...
  "calibration": {
    "available": true,
    "ece": 0.1494230262149967,
    "mce": 0.2659798406771372,
    "reliability_bins": [
      {
        "lo": 0.0,
        "hi": 0.1,
      ...
      },
      {
        ...
        "count": 3,
        "accuracy": 1.0,
        "confidence": 0.9366077674438009
      }
    ],
    "brier_score": 0.25153662086065226
  },
  "auroc": 0.6273637374860956,
  "split_strategy": "group_run",
  "split_warnings": [],
  "latency": {
    "mean_inference_latency_ms": 0.3470463501798804,
    "p95_inference_latency_ms": 0.47295295062212966,
    "p99_inference_latency_ms": 0.6198258808944952,
    "throughput_samples_per_sec": 2881.459492317617
  },
  "per_subject": {
    "S001": {
      "task_type": "classification",
