# Model Card: physionet_eegbci_medium_csp_logreg_csp2
...
```json
{
  ...
  "balanced_accuracy": 0.5390831619159565,
  "macro_f1": 0.5380194518125552,
  "weighted_f1": 0.5381721726549312,
  "per_class": {
    "LEFT_HAND_IMAGERY": {
    ...
    "accuracy": 0.5393939393939394,
    "macro avg": {
      "precision": 0.5395010395010396,
      "recall": 0.5390831619159565,
      "f1-score": 0.5380194518125552,
      "support": 165.0
    },
    "weighted avg": {
      "precision": 0.5394947394947396,
      "recall": 0.5393939393939394,
      "f1-score": 0.5381721726549312,
      "support": 165.0
    }
  },
  "confusion_matrix": [
  ...
  "calibration": {
    "available": true,
    "ece": 0.05157353753930535,
    "mce": 0.22184494706037294,
    "reliability_bins": [
      {
        "lo": 0.0,
        "hi": 0.1,
    ...
    "brier_score": 0.2536972086028205
  },
  "auroc": 0.5264472524243314,
  "split_strategy": "group_run",
  "split_warnings": [],
  "latency": {
    "mean_inference_latency_ms": 0.3115729332476445,
    "p95_inference_latency_ms": 0.3833345988823566,
    "p99_inference_latency_ms": 0.4418375202658339,
    "throughput_samples_per_sec": 3209.5214098882575
  },
  "per_subject": {
    "S001": {
      "task_type": "classification",
    ...
    "S010": {
      ...
      "weighted_f1": 0.5074074074074075,
      "per_class": {
        "LEFT_HAND_IMAGERY": {
          "precision": 0.625,
          "recall": 0.3125,
  ...
  "per_run": {
    "12": {
      ...
      "balanced_accuracy": 0.5108695652173914,
      "macro_f1": 0.5108695652173914,
      "weighted_f1": 0.5111111111111111,
      "per_class": {
        "LEFT_HAND_IMAGERY": {
