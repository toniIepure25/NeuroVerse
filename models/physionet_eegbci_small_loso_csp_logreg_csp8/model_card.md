# Model Card: physionet_eegbci_small_loso_csp_logreg_csp8
...
```json
{
  ...
  "calibration": {
    "available": true,
    "ece": 0.3926972574927037,
    "mce": 0.48788211382338925,
    "reliability_bins": [
      {
        "lo": 0.0,
        "hi": 0.1,
      ...
      },
      {
        ...
        "confidence": 0.9424275683688438
      }
    ],
    "brier_score": 0.4080192366399459
  },
  "auroc": 0.49604743083003955,
  "split_strategy": "leave_one_subject_out",
  "split_warnings": [],
  "latency": {
    "mean_inference_latency_ms": 0.33619306640402,
    "p95_inference_latency_ms": 0.4037293998408131,
    "p99_inference_latency_ms": 0.5610242398688575,
    "throughput_samples_per_sec": 2974.4813320993658
  },
  "per_subject": {
    "S003": {
      "task_type": "classification",
