# Model Card: physionet_eegbci_small_loso_csp_lda_csp8
...
```json
{
  ...
  "calibration": {
    "available": true,
    "ece": 0.47952547534823947,
    "mce": 0.7408694926804547,
    "reliability_bins": [
      {
        "lo": 0.0,
        "hi": 0.1,
      ...
      },
      {
        ...
        "confidence": 0.9853376144894365
      }
    ],
    "brier_score": 0.4727148255669707
  },
  "auroc": 0.5592885375494071,
  "split_strategy": "leave_one_subject_out",
  "split_warnings": [],
  "latency": {
    "mean_inference_latency_ms": 0.3718949111417815,
    "p95_inference_latency_ms": 0.511313399329083,
    "p99_inference_latency_ms": 0.7671285200922292,
    "throughput_samples_per_sec": 2688.931657950972
  },
  "per_subject": {
    "S003": {
      "task_type": "classification",
